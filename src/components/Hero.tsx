      ...
      >
        ...
        >
          ...
          <p
            ...
            className="font-sora text-xs sm:text-xs md:text-sm font-light tracking-tight sm:tracking-wide text-[#F4F5F8] leading-snug sm:leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.95)]"
          >
            <span className="sm:hidden block">
              A quieter side of Manhattan, where tree-lined streets meet all the shopping & transit conveniences.
            </span>
        ...
        >
          ...
          >
            <span className="sm:hidden block">
              23-stories tall with over fifteen amenity spaces between them. 198 spectacular homes, ranging from studios to three-bedrooms with private outdoor spaces in select units.
            </span>
