  ...
  return (
    <section className="bg-[#F4F5F8] text-[#101535] py-16 md:py-24 px-6 sm:px-12 lg:px-20 w-full border-y border-[#D6B585]/40 select-none">
      <div className="w-full max-w-6xl mx-auto text-center space-y-8">
        ...
        <p className="font-sora text-lg sm:text-2xl md:text-3xl leading-[1.65] text-[#101535]/90 font-light tracking-tight max-w-5xl mx-auto text-center [text-wrap:balance]">
        ...
        <div className="pt-2">
          <button
            ...
            className="px-9 py-4 rounded-none bg-[#101535] text-[#D6B585] border border-[#D6B585]/40 hover:bg-[#242C5B] hover:scale-105 font-sora text-xs tracking-wider font-semibold uppercase transition-all duration-300 shadow-md cursor-pointer"
          >
            Schedule a Tour
          </button>
        </div>
