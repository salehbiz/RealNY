...
export const SkylineSection: React.FC<SkylineSectionProps> = ({
  ...
  const categories = [
    ...
    },
    {
      ...
      tabLabel: 'Interior',
      title: 'Interior',
      description: 'Every home features floor-to-ceiling windows, up to nine-foot ceilings, engineered hardwood flooring, and custom built-out closets, while select residences are enhanced by double exposures and private balconies or terraces.',
    ...
    },
    {
      ...
      tabLabel: 'Amenities',
      title: 'Amenities',
      description: 'Beyond the residences, more than fifteen amenity spaces are distributed across both towers.',
